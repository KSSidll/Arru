...
class RegexHelper {
    companion object {
         ...
         * @param decimalPoints Optional max amount of digits after the non digit character, null means no limit
         * @return True if [value] is a representation of digits optionally divided by some other character, False otherwise
         */
        fun isFloat(
            value: String,
