...
@Composable
fun DashboardAverageAndMedianSpendingComponent(
...
@Preview(
    group = "Dashboard Average And Median Spending Component",
    name = "Dark",
    showBackground = true,
...
@Composable
fun DashboardAverageAndMedianSpendingComponentPreview() {
    ArrugarqTheme {
        Surface {
            DashboardAverageAndMedianSpendingComponent(
