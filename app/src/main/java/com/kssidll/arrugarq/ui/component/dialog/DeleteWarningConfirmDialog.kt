        ...
        Surface(
            ...
            Column(
                ...
                Row(
                    ...
                    Text(
                        text = stringResource(id = com.kssidll.arrugarq.R.string.destructive_action_confirmation_text),
                        style = Typography.bodyLarge,
                    )
                }
                ...
                Row {
                    Button(
                        ...
                        Text(
                            text = stringResource(id = com.kssidll.arrugarq.R.string.destructive_action_cancel),
                            style = Typography.bodyLarge,
                        )
                    }
                    ...
                    Button(
                        ...
                        Text(
                            text = stringResource(id = com.kssidll.arrugarq.R.string.destructive_action_confirm),
                            style = Typography.bodyLarge,
                        )
                    }
                }
