...
data class TransactionEntity(
    ...
    constructor(
        ...
        shopEntityId: Long?,
        note: String?,
    ) : this(0, date, shopEntityId, totalCost, note)
    ...
    companion object {
        ...
        @Ignore const val INVALID_DATE: Long = Long.MIN_VALUE

        @Ignore const val INVALID_TOTAL_COST: Long = Long.MIN_VALUE
        ...
        fun actualTotalCost(cost: Long): Float {
            return cost.toFloat().div(COST_DIVISOR)
        }
