...
interface ProductVariantRepositorySource {
     ...
     *
     * @param productId id of the [ProductEntity] to insert the [ProductVariantEntity] for, null for
     *   global [ProductVariantEntity]
     * @param name name of the variant
     * @return [InsertResult] with id of the newly inserted [ProductVariantEntity] or an error if
     *   any
     */
    suspend fun insert(productId: Long?, name: String): InsertResult
     ...
     *
     * @param id id to match [ProductVariantEntity]
     * @param productId [ProductEntity] id to update the matching [ProductVariantEntity] to, null
     *   for global [ProductVariantEntity]
     * @param name name to update the matching [ProductVariantEntity] to
     * @return [UpdateResult] with the result
     */
    suspend fun update(id: Long, productId: Long?, name: String): UpdateResult
