...
class GetTotalSpentByDayUseCase(
    private val transactionRepository: TransactionRepositorySource,
) {
    operator fun invoke(
        dispatcher: CoroutineDispatcher = Dispatchers.IO,
...
class GetTotalSpentByWeekUseCase(
    private val transactionRepository: TransactionRepositorySource,
) {
    operator fun invoke(
        dispatcher: CoroutineDispatcher = Dispatchers.IO,
...
class GetTotalSpentByMonthUseCase(
    private val transactionRepository: TransactionRepositorySource,
) {
    operator fun invoke(
        dispatcher: CoroutineDispatcher = Dispatchers.IO,
...
class GetTotalSpentByYearUseCase(
    private val transactionRepository: TransactionRepositorySource,
) {
    operator fun invoke(
        dispatcher: CoroutineDispatcher = Dispatchers.IO,
