...
class PersistentNotificationService : Service() {
    ...
    private fun makeNotificationChannel(): NotificationChannelCompat {
        ...
        return NotificationChannelCompat.Builder(
            ...
            .setDescription(
                getLocalizedString(R.string.service_persistent_notification_description)
            )
    ...
    private fun createNotification(): Notification {
        ...
        return builder
            .setContentTitle(
                "$APPLICATION_NAME - ${getLocalizedString(R.string.persistent_notification_add_transaction)}"
            )
    ...
    private fun updateNotification() {
        ...
        if (
            ...
            Log.d(TAG, "updateNotification: updating")
